...
function () {
    ...
    if (!tahmin) {
        ...
        document.querySelector(".check").textContent = "Tebrikler"
        document.querySelector('.again').style.display = 'block'
        if (puan > yüksekPuan) {
            yüksekPuan = puan
            document.querySelector(".highscore").textContent = yüksekPuan
            // Doğru olduğunda Tebrikler Ekranına basınca Sayfa Yenilenir
            // document.querySelector(".check").addEventListener("click",
            //     function () {
            //         puan = 20
        ...
        if (puan > 1) {
            ...
            ekranMesajı(puan <= 20 ? "Sayı 20 den yüksek" : "Numara Girin ")
            puan--
            document.querySelector(".score").textContent = puan
        }
        else {
            ...
            document.querySelector(".score").textContent = 0
            document.querySelector(".check").textContent = "Kaybettiniz"
            document.querySelector('.again').style.display = 'block'
        }
